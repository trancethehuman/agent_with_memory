...
from memory import messages_history, summarizer, entities, summaries, messages_history_counter, messages_history_threshold
...
conversation = LLMChain(
    llm=llm, verbose=True, prompt=life_coach_prompt, output_key="response")
